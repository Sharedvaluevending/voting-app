...
const userSchema = new mongoose.Schema({
  ...
  trenchAuto: {
    ...
    lastRunAt: { type: Date },
    tpPercent: { type: Number, default: 18, min: 5, max: 50 },
    slPercent: { type: Number, default: 12, min: 3, max: 30 },
    trailingStopPercent: { type: Number, default: 8, min: 3, max: 20 },
    ...
    maxHoldMinutes: { type: Number, default: 20, min: 5, max: 60 },
